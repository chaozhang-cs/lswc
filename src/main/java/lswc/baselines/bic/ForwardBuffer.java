...
public class ForwardBuffer {
    ...
    RootAndChild insertEdgeAndGetRoots(int source, int target) {
        ...
        if (rootOfSource != rootOfTarget) {
            ...
            rootAndChildInF.child = BidirectionalIncrementalConnectivity.EMPTY_ROOT;
        }
    ...
    public boolean intraConnected(int source, int target, RootPair rootsInF) {
        ...
        if (sourceTreeNode != null) {
            ...
            rootsInF.sourceRoot = BidirectionalIncrementalConnectivity.EMPTY_ROOT;
            rootsInF.numOfEmpty++;
        }
        ...
        if (targetTreeNode != null) {
            ...
            rootsInF.targetRoot = BidirectionalIncrementalConnectivity.EMPTY_ROOT;
            rootsInF.numOfEmpty++;
        }
